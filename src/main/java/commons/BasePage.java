...
public class BasePage {
	...
	public void selectItemDefaultDropdown(WebDriver driver, String xpathParentLocator, String xpathItemLocator,
			String textItem) {
	...
	public void hoverMouseOverElement(WebDriver driver, String locatorType) {
	...
	public BasePage openPagesAtMyAccountByName(WebDriver driver, String pageName) {
		waitForElementClickable(driver, BasePageUI.DYNAMIC_PAGE_SIDEBAR, pageName);
		clickElement(driver, BasePageUI.DYNAMIC_PAGE_SIDEBAR, pageName);
		switch (pageName) {
		case "Customer info":
	 ...
	 * @param dynamicValues
	 */
	public void sendKeysToTextboxByID(WebDriver driver, String locatorType, String text, String... dynamicValues) {
		waitForElementVisible(driver, locatorType, dynamicValues);
		sendKeysToElement(driver, locatorType, text, dynamicValues);
	}
	 ...
	 * @param dynamicValues
	 */
	public void clickButtonByText(WebDriver driver, String locatorType, String... dynamicValues) {
		waitForElementClickable(driver, locatorType, dynamicValues);
		clickElement(driver, locatorType, dynamicValues);
	}
